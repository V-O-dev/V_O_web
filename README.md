...
- **알림** - 매일 특정 시간, 그룹 성격에 맞는 오늘의 질문 도착
- **촬영** - 질문 확인 후 10초간 무편집 답변 영상 촬영
- **해제** - 업로드 즉시 블러 처리된 다른 멤버들의 영상 공개
- **반응** - 이모지, 댓글로 서로의 일상에 가볍게 반응
- **축적** - 영상이 나의 달력에 날짜별로 누적되어 추억 보관함이 됨
...
flowchart TD
    ...
    O -->|피드 영상 클릭| V["⚠️ /video/:id<br/>(라우트 미구현)"]
```
